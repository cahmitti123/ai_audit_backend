 ...
 */
chatRouter.get("/audits/:audit_id/chat/history", async (req: Request, res: Response) => {
  try {
 ...
 *           text/event-stream: {}
 */
chatRouter.post("/audits/:audit_id/chat", async (req: Request, res: Response) => {
  try {
    const auditId = BigInt(req.params.audit_id);
 ...
 */
chatRouter.get("/fiches/:fiche_id/chat/history", async (req: Request, res: Response) => {
  try {
 ...
 */
chatRouter.post("/fiches/:fiche_id/chat", async (req: Request, res: Response) => {
  try {
    const { fiche_id } = req.params;
    const { message } = req.body;
